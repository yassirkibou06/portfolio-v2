...
const Hero = () => {
    ...
    return (
        <div className="px-16 mt-16 grid grid-cols-6 grid-rows-hero gap-y-4 gap-x-5">
            {/* div 1 */}
            <motion.div
                ...
                className="bg-glass z-10 col-span-4 rounded-3xl relative overflow-hidden"
            >
                <motion.div
                ...
                <div className="z-[52] absolute">
                    <motion.h2
                        ...
                        className="ml-10 mt-14 text-white font-semibold text-5xl tracking-wide w-[50%]">
                        3 Years in the Code Forge
                    </motion.h2>
                    <motion.p
                        transition={{ duration: 0.2 }}
                        animate={showDiv1 ? { scale: 1.1 } : { scale: 1 }}
                        className="absolute left-[60%] top-60 text-white w-[50%]">
                        Hello, I&apos;m Yassir, a seasoned Front-end Developer with a three-year
                        journey in the ever-evolving world of web development.
                    </motion.p>
                    <Link href="/about" className="absolute top-64 left-24 flex items-center justify-center w-12 h-12 bg-white hover:bg-glass rounded-full">
            ...
            <motion.div
                ...
                <div className="absolute top-32 left-2 z-[52]">
                    <motion.h2
                        transition={{ duration: 0.3 }}
                        initial={{ opacity: 0 }}
                        animate={{ opacity: showDiv2 ? 1 : 0, y: showDiv2 ? 0 : 30, transition: { duration: 0.5 } }}
                        exit={{ opacity: 0 }}
                        className="mt-14 font-semibold text-xl tracking-wide">
                        My Portfolio
                    </motion.h2>
                    <motion.p
                        //transition={{ duration: 0.5 }}
                    ...
                    <Link href="/work" className="absolute top-36 right-3 flex items-center justify-center w-9 h-9 bg-white hover:bg-glass rounded-full">
            ...
            <motion.a
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[51]">
                    <motion.h2
                        ...
                        exit={{ opacity: 0 }}
                        className="mt-14 font-semibold text-white transform rotate-90 text-3xl tracking-widest">
                        FREELANCER
                    </motion.h2>
                </div>
            </motion.a>
            ...
            animate={{ opacity: 1, x: 0, transition: { duration: 1.8 } }}
